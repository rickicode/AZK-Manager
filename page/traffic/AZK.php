...
if (isset($_GET['get-stats'])) {
    ...
    $data = array(
        ...
        'monthlySales' => isset($API->comm("/system/script/print", array("?name" => "monthlyincome"))['0']["source"]) ? $MikroTik['currency'] . number_format($API->comm("/system/script/print", array("?name" => "monthlyincome"))['0']["source"]) : '<a class="text-danger text-decoration-none" href="/script#script">Script Error</a>',
        'dailySales' => isset($API->comm("/system/script/print", array("?name" => "todayincome"))['0']["source"]) ? $MikroTik['currency'] . number_format($API->comm("/system/script/print", array("?name" => "todayincome"))['0']["source"]) : '<a class="text-danger text-decoration-none" href="/script#script">Script Error</a>',
