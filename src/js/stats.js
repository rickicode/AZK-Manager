...
function requestData(iface) {
    ...
    xmlhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            $('#stats2').html('<div class="col mr-2"> <div class="fw-bold text-warning">MikroTik</div><div class="mb-0 fw-bold text-gray-800">' + obj.identity + '</div><div class="fw-bold text-warning">Uptime</div><div class="mb-0 fw-bold text-gray-800">' + obj.stats['uptime'] + '</div></div><div class="col mr-2"> <div class="fw-bold text-warning"> Router </div><div class="mb-0 fw-bold text-gray-800">' + obj.stats['board-name'] + " " + obj.stats['version'] + '</div></div>');
